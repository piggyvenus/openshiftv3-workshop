...
In the search text box type `Red Hat JBoss EAP 6.4` and select the
latest version tag for this builder image (at the moment of creation
this lab it is `Red Hat JBoss EAP 6.4 1.6`).
...
Click on the blue link that says: *Advanced Options*
...
Ex:-  http://nexus-artrepo.apps.devday.ocpcloud.com/repository/maven-public/
....
