...
"consoleproject-UserName" using the following command:
...
`oc get pods`). You will find one pod for mysql running. Take a note of
it's name.
...
_Tip:_ If you need service ip address navigate to
*Applications->Services* tab on the Web Console.
...
image:images/dbtest_build.png[image]
