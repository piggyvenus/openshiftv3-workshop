...
ks        ks-myjbossapp-Username.{{APPS_ADDRESS}}                                 ks         8080-tcp
....
...
....
$ curl ks-myjbossapp-UserName.{{APPS_ADDRESS}}
...
Go to https://ks-myjbossapp-Username.{{APPS_ADDRESS}} via your browser.
